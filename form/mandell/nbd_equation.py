#!/usr/bin/env python3
"""NBD equation — post NBD x10 levels."""
...
L_STAR = 3
SPINE = ("mandell","dell_matrix","duobeta","plane","main","integrate","resonance","enhance","persist","ui")
...
CAPS: List[Cap] = [
    ...
    Cap("shared_main", "SharedMain", "main", 3, 0.88),
...
def main() -> None:
    ...
    ranked = rank()
    if not ranked:
        print("Δ empty for L* on tracked Form caps.")
        return
    for c in ranked:
