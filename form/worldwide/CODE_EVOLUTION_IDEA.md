...
- ResourceShell
- GrowthResidue
- OpenShell — refuses silent Boolean collapse; .as_bool() is explicit last-resort only

Plant in session (example):

```text
create an idea called Code Evolution detail: post-Boolean decision shells and intuitive Mandell-bound coding surface goals: exhaust known shells into operators; defer Boolean collapse; honesty on projections
```
