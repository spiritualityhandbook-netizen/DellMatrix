...
```text
create an idea called Code Evolution detail: post-Boolean decision shells and intuitive Mandell-bound coding surface goals: exhaust known shells into operators; intuitive language surface; honesty on projections
```
